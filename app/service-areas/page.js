...
const faqItems = [
  ...
  },
  {
    ...
    a: "Our route is built around Celina, which is how we keep service days reliable. For homes just over the line — the Prosper side of Frontier Parkway, or out toward Weston — call and ask. If it fits the route, we'll take it.",
  },
  {
      ...
      <section className="page-hero">
        <div className="container">
          ...
          <p>
            ...
            tacked on — Celina. Here&rsquo;s where our trucks spend the week,
