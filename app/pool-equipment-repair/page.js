...
export const metadata = {
  ...
  description:
    "Pool pump repair, filter service, timer and equipment-pad fixes in Celina, TX. Honest diagnosis first — repair when it makes sense, replacement advice when it doesn't.",
...
const faqItems = [
  {
    ...
    a: "Usually failing motor bearings, sometimes cavitation from a suction-side air leak. Bearings on an older single-speed pump often mean it's worth pricing a variable-speed replacement instead of a repair — newer pumps cost far less to run all season. We'll give you both numbers and let you decide.",
  },
  {
  ...
  return (
    <>
      ...
      <section>
        <div className="container two-col">
          <div>
            ...
            <p>
              Celina has two kinds of pools. The newer communities — Light
              Farms, Lilyana, Sutton Fields, Cambridge Crossing — have
            ...
            <PhotoPlaceholder
              tall
              note="Real photo: equipment pad shot — tech replacing a pump seal or cleaning a cartridge filter at a local home. Show the work, not a showroom."
            />
          </div>
      ...
      <CtaBand
        ...
        sub="Describe the noise, the leak, or the error light — we'll tell you what it likely is before we roll a truck."
      />
    </>
  );
}
