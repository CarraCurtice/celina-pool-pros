...
export const SITE = {
  ...
  // Formspree endpoint — static export = no server code, so the
  // quote form POSTs directly to Formspree.
  formEndpoint: "https://formspree.io/f/xqpzbkbw",

  // Google Analytics 4 measurement ID
  gaMeasurementId: "G-PZ0HX5L89D",
